...
export const tokenExchangeRecipes = [
...
// ==================== TAMBAHAN DATA YANG KURANG ====================

// Push atlantisSpot dan valinorSpot ke fishingSpots
fishingSpots.push(atlantisSpot);
fishingSpots.push(valinorSpot);

// Village Upgrades Function (butuh untuk shop)
export function getVillageUpgrades() {
    return [
...
// Global variables (awal game)
export let currentSpot = 0;
export let currentDepth = "surface";
export let isFishing = false;
export let currentPullHandler = null;
export let autoSellSettings = { basic: false, legendary: false };
export let caughtSecretSpots = { 
    danau: false, kuil: false, laut: false, sungai: false, 
    angkasa: false, brainrot: false, crypto: false, 
    atlantis: false, valinor: false 
};

// DOM Elements (akan diisi saat init)
export let coinsElement, diamondsElement, expElement, levelElement, fishBtn, gachaBtn;
export let backpackItems, shopItems, sellItems, sellTotal, sellBtn, sellAllBtn;
export let resultModal, gachaModal, exchangeModal, rankModal, dungeonModal, battleModal, miningModal, miningResultModal;
export let resultTitle, resultContent, gachaTitle, gachaContent, miningResultContent;
export let minigameIndicator, miningMinigameIndicator;