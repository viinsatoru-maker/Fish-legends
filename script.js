...
let arenaTierSelect, arenaFishSelect, arenaFightBtn, showGraveyardBtn, buyGamepassBtn;
let gamepassProgressBar, gamepassLevelDisplay, gamepassExpDisplay;
let gamepassFreeRewards, gamepassPremiumRewards;
...
function initializeDOMElements() {
    ...
    showGraveyardBtn = document.getElementById('show-graveyard-btn');
    buyGamepassBtn = document.getElementById('buy-gamepass-btn');
    ...
    gamepassFreeRewards = document.getElementById('gamepass-free-rewards');
    gamepassPremiumRewards = document.getElementById('gamepass-premium-rewards');
...
function setupEventListeners() {
    ...
    // Arena buttons - PAKAI VARIABEL GLOBAL
    if (arenaTierSelect) {
...
function loadGamepass() {
    ...
    // Load rewards
    if (gamepassFreeRewards) {
        gamepassFreeRewards.innerHTML = '<p>Free rewards akan tampil di sini</p>';
    }
    if (gamepassPremiumRewards) {
        gamepassPremiumRewards.innerHTML = '<p>Premium rewards akan tampil di sini</p>';
    }
}
